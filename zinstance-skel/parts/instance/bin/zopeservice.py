...
PYTHON = r'/plone/Python-2.4/bin/python'
SOFTWARE_HOME=r'/plone/Zope-2.10.13-final-py2.4/lib/python'
INSTANCE_HOME = r'/plone/zinstance/parts/instance'
ZOPE_HOME = r'/plone/Zope-2.10.13-final-py2.4'
